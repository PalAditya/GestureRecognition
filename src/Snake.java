...
public class Snake implements ActionListener,KeyListener
{
    ...
    int ticks,direction,up,down,left,right,scale,score,tail,speed,flag;
    Point head,food;
    Random random;
    ...
    Snake()
    {   
        ticks=0;direction=1;up=0;down=1;left=2;right=3;scale=10;score=0;tail=1;speed=10;flag=0;snakeParts=new ArrayList<>();tick=new ArrayList<>();
    }
